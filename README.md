...
To run the code you will need to download a couple of packages and change the input and output directories in the script. You will need to put the AIS data into the input folder.
